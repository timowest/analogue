...
class AnalogueGUI : public LV2::GUI<AnalogueGUI, LV2::URIMap<true>, LV2::WriteMIDI<false> > {
    public:
        ...
        AnalogueGUI(const std::string& URI) {
            ...
            mainBox.pack_start(*createTable(0, 11), PACK_EXPAND_PADDING);  // amp1
            mainBox.pack_start(*createTable(11, 22), PACK_EXPAND_PADDING); // amp2
            mainBox.pack_start(*createTable(22, 35), PACK_EXPAND_PADDING); // filter1
            mainBox.pack_start(*createTable(35, 48), PACK_EXPAND_PADDING); // filter2
            mainBox.pack_start(*createTable(48, 53), PACK_EXPAND_PADDING); // lfo1
            mainBox.pack_start(*createTable(53, 58), PACK_EXPAND_PADDING); // lfo2
            mainBox.pack_start(*createTable(58, 61), PACK_EXPAND_PADDING); // noise
            mainBox.pack_start(*createTable(61, 70), PACK_EXPAND_PADDING); // osc1
            mainBox.pack_start(*createTable(70, control_ports), PACK_EXPAND_PADDING); // osc2
